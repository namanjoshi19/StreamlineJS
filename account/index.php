...
<script src="https://www.google.com/recaptcha/api.js?render=6Le5NsMZAAAAAGv4ZylH0rEyu6ikXXz1VAXXmGih"></script>
...
/*background: linear-gradient(124deg, rgba(255,45,45,1) 0%, rgba(249,183,26,1) 100%);*/
	...
	/*background: linear-gradient(129deg, rgba(132,0,24,1) 0%,  rgba(85,7,254,1) 108%);*/
		...
		background: linear-gradient(129deg, rgb(4, 53, 42) 0%, rgb(198, 66, 196) 108%);
	}
	
	.secondary_back {
		background:linear-gradient(30deg, rgba(15, 52, 89, 0.7) 0%, rgba(53, 4, 4, 0.7) 88%);
		/*background:linear-gradient(30deg, rgba(250, 54, 96, 0.77) 0%, rgba(52, 120, 81, 0.7) 88%);
